...
class MCTSAgent:
    def __init__(self, name, max_search_depth=2, exploration_const=1.414):
        self.name = name
...
class MCTS:
    def __init__(self, exploration_const=1.414, max_search_depth=2):
